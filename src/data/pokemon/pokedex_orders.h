...
const u16 gPokedexOrder_Alphabetical[] =
{
    ...
    NATIONAL_DEX_WEEPILLAR,
    NATIONAL_DEX_COCCOOPSY,
    NATIONAL_DEX_APOLOFLY,
    ...
    NATIONAL_DEX_HOODENKI,
    NATIONAL_DEX_VANOWL,
    NATIONAL_DEX_EMPEROSS,
    NATIONAL_DEX_STANDAAD,
    NATIONAL_DEX_RECKLOAT,
    NATIONAL_DEX_DEVILOAT,
    /*NATIONAL_DEX_KITKAR,
    NATIONAL_DEX_CANNEKO,*/
    NATIONAL_DEX_HUGREAM,
    NATIONAL_DEX_TRAUMARE,
    NATIONAL_DEX_PIKASH,
    ...
    NATIONAL_DEX_LEMONAVIAN,
    NATIONAL_DEX_MUNCHARLIE,
    NATIONAL_DEX_FINGATOR,
    NATIONAL_DEX_GARASITE,
    NATIONAL_DEX_OWLIE,
    NATIONAL_DEX_CHRYTHICAL,
    NATIONAL_DEX_GRIFFETER,
    NATIONAL_DEX_MUSTELIT,
    NATIONAL_DEX_CAPENSEAR,
    NATIONAL_DEX_DATHOKYD,
    NATIONAL_DEX_SITHABRAK,
    NATIONAL_DEX_MURMIC,
    NATIONAL_DEX_WHISPECTRA,
    NATIONAL_DEX_DREAMIE,
    NATIONAL_DEX_DREAMENACE,
    NATIONAL_DEX_CUBBLE,
    NATIONAL_DEX_GESUNDHA,
    NATIONAL_DEX_MINETLE,
    NATIONAL_DEX_TORTOMOTIV,
    NATIONAL_DEX_DINUGGET,
    NATIONAL_DEX_SPINOSNAX,
    NATIONAL_DEX_GANECK,
    NATIONAL_DEX_ALIENOOSE,
    NATIONAL_DEX_MIMICRATE,
    NATIONAL_DEX_WHALLIC,
    NATIONAL_DEX_ENORMEAT,
    NATIONAL_DEX_VEGAVA,
    ...
    NATIONAL_DEX_LOCOMALTER,
    NATIONAL_DEX_PUPYRO,
    NATIONAL_DEX_PYRULPES,
    NATIONAL_DEX_KITSINICAL,
    NATIONAL_DEX_FINGRAGON,
    NATIONAL_DEX_HYDRAMILY,
    NATIONAL_DEX_GEODAD,
    NATIONAL_DEX_SNOZOMI,
    NATIONAL_DEX_EVERIPST,
    NATIONAL_DEX_DARKORPSE,
    NATIONAL_DEX_HATCHAAL,
    NATIONAL_DEX_CRUSYGLE,
    NATIONAL_DEX_ZALGOSIX,
    NATIONAL_DEX_ZALGONER,
    NATIONAL_DEX_SCORPEWON,
    NATIONAL_DEX_TSARACHNID,
    NATIONAL_DEX_KPOPPET,
    NATIONAL_DEX_GANGNAMP,
    NATIONAL_DEX_SURFICE,
    NATIONAL_DEX_MACABRERG,
    NATIONAL_DEX_ELDRACIER,
