static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_HOMEGE_TOWN - 1] = {MAP_GROUP(HOMEGE_TOWN), MAP_NUM(HOMEGE_TOWN), 13, 17},
    [HEAL_LOCATION_ICOVALE_CITY - 1] = {MAP_GROUP(ICOVALE_CITY), MAP_NUM(ICOVALE_CITY), 27, 47},
};
