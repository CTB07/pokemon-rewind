...
PLACEHOLDER_ANIM_SINGLE_FRAME(Paropeat);
PLACEHOLDER_ANIM_SINGLE_FRAME(Macaument);
PLACEHOLDER_ANIM_SINGLE_FRAME(Arguwint);
PLACEHOLDER_ANIM_SINGLE_FRAME(Primatio);
PLACEHOLDER_ANIM_SINGLE_FRAME(Opinimp);
PLACEHOLDER_ANIM_SINGLE_FRAME(Temperilla);
PLACEHOLDER_ANIM_SINGLE_FRAME(Substee);
PLACEHOLDER_ANIM_SINGLE_FRAME(Manember);
PLACEHOLDER_ANIM_SINGLE_FRAME(Trechiber);
PLACEHOLDER_ANIM_SINGLE_FRAME(Weepillar);
PLACEHOLDER_ANIM_SINGLE_FRAME(Coccoopsy);
PLACEHOLDER_ANIM_SINGLE_FRAME(Apolofly);
/*PLACEHOLDER_ANIM_SINGLE_FRAME(Bulbite);
PLACEHOLDER_ANIM_SINGLE_FRAME(Lampupa);
PLACEHOLDER_ANIM_SINGLE_FRAME(Elecreep);*/
PLACEHOLDER_ANIM_SINGLE_FRAME(Acturunk);
PLACEHOLDER_ANIM_SINGLE_FRAME(Dramaspire);
PLACEHOLDER_ANIM_SINGLE_FRAME(Burrobit);
PLACEHOLDER_ANIM_SINGLE_FRAME(Rabbitate);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hoodenki);
PLACEHOLDER_ANIM_SINGLE_FRAME(Vanowl);
PLACEHOLDER_ANIM_SINGLE_FRAME(Empeross);
/*PLACEHOLDER_ANIM_SINGLE_FRAME(Cuckoob);
PLACEHOLDER_ANIM_SINGLE_FRAME(Twiddies);
PLACEHOLDER_ANIM_SINGLE_FRAME(Airiola);*/
PLACEHOLDER_ANIM_SINGLE_FRAME(Standaad);
PLACEHOLDER_ANIM_SINGLE_FRAME(Reckloat);
PLACEHOLDER_ANIM_SINGLE_FRAME(Deviloat);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hugream);
PLACEHOLDER_ANIM_SINGLE_FRAME(Traumare);
/*PLACEHOLDER_ANIM_SINGLE_FRAME(Kitkar);
PLACEHOLDER_ANIM_SINGLE_FRAME(Canneko);*/
PLACEHOLDER_ANIM_SINGLE_FRAME(Pikash);
PLACEHOLDER_ANIM_SINGLE_FRAME(Sonikachu);
PLACEHOLDER_ANIM_SINGLE_FRAME(Grubfeed);
PLACEHOLDER_ANIM_SINGLE_FRAME(Kwizbee);
PLACEHOLDER_ANIM_SINGLE_FRAME(Cosmonarch);
PLACEHOLDER_ANIM_SINGLE_FRAME(Paastel);
PLACEHOLDER_ANIM_SINGLE_FRAME(Sheepastry);
PLACEHOLDER_ANIM_SINGLE_FRAME(Typurr);
PLACEHOLDER_ANIM_SINGLE_FRAME(Calikey);
PLACEHOLDER_ANIM_SINGLE_FRAME(Spookids);
PLACEHOLDER_ANIM_SINGLE_FRAME(Togeterror);
PLACEHOLDER_ANIM_SINGLE_FRAME(Bubozoa);
PLACEHOLDER_ANIM_SINGLE_FRAME(Chrysapod);
/*PLACEHOLDER_ANIM_SINGLE_FRAME(Argigami);
PLACEHOLDER_ANIM_SINGLE_FRAME(Disputraw);
PLACEHOLDER_ANIM_SINGLE_FRAME(Disputrawspecial);*/
PLACEHOLDER_ANIM_SINGLE_FRAME(Lemonavian);
PLACEHOLDER_ANIM_SINGLE_FRAME(Muncharlie);
PLACEHOLDER_ANIM_SINGLE_FRAME(Fingator);
PLACEHOLDER_ANIM_SINGLE_FRAME(Garasite);
PLACEHOLDER_ANIM_SINGLE_FRAME(Owlie);
PLACEHOLDER_ANIM_SINGLE_FRAME(Chrythical);
PLACEHOLDER_ANIM_SINGLE_FRAME(Griffeter);
PLACEHOLDER_ANIM_SINGLE_FRAME(Mustelit);
PLACEHOLDER_ANIM_SINGLE_FRAME(Capensear);
PLACEHOLDER_ANIM_SINGLE_FRAME(Dathokyd);
PLACEHOLDER_ANIM_SINGLE_FRAME(Sithabrak);
PLACEHOLDER_ANIM_SINGLE_FRAME(Murmic);
PLACEHOLDER_ANIM_SINGLE_FRAME(Whispectra);
PLACEHOLDER_ANIM_SINGLE_FRAME(Dreamie);
PLACEHOLDER_ANIM_SINGLE_FRAME(Dreamenace);
PLACEHOLDER_ANIM_SINGLE_FRAME(Cubble);
PLACEHOLDER_ANIM_SINGLE_FRAME(Gesundha);
PLACEHOLDER_ANIM_SINGLE_FRAME(Minetle);
PLACEHOLDER_ANIM_SINGLE_FRAME(Tortomotiv);
PLACEHOLDER_ANIM_SINGLE_FRAME(Dinugget);
PLACEHOLDER_ANIM_SINGLE_FRAME(Spinosnax);
PLACEHOLDER_ANIM_SINGLE_FRAME(Ganeck);
PLACEHOLDER_ANIM_SINGLE_FRAME(Alienoose);
PLACEHOLDER_ANIM_SINGLE_FRAME(Mimicrate);
PLACEHOLDER_ANIM_SINGLE_FRAME(MimicrateDisguised);
PLACEHOLDER_ANIM_SINGLE_FRAME(Whallic);
PLACEHOLDER_ANIM_SINGLE_FRAME(Enormeat);
PLACEHOLDER_ANIM_SINGLE_FRAME(Vegava);
PLACEHOLDER_ANIM_SINGLE_FRAME(Gluttocado);
PLACEHOLDER_ANIM_SINGLE_FRAME(Postle);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hushback);
PLACEHOLDER_ANIM_SINGLE_FRAME(Donkrime);
PLACEHOLDER_ANIM_SINGLE_FRAME(Mafiadass);
PLACEHOLDER_ANIM_SINGLE_FRAME(Locomalter);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pupyro);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pyrulpes);
PLACEHOLDER_ANIM_SINGLE_FRAME(Kitsinical);
PLACEHOLDER_ANIM_SINGLE_FRAME(Fingragon);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hydramily);
PLACEHOLDER_ANIM_SINGLE_FRAME(Geodad);
PLACEHOLDER_ANIM_SINGLE_FRAME(Snozomi);
PLACEHOLDER_ANIM_SINGLE_FRAME(Everipst);
PLACEHOLDER_ANIM_SINGLE_FRAME(Darkorpse);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hatchaal);
PLACEHOLDER_ANIM_SINGLE_FRAME(Crusygle);
PLACEHOLDER_ANIM_SINGLE_FRAME(Zalgosix);
PLACEHOLDER_ANIM_SINGLE_FRAME(Zalgoner);
PLACEHOLDER_ANIM_SINGLE_FRAME(Scorpewon);
PLACEHOLDER_ANIM_SINGLE_FRAME(Tsarachnid);
PLACEHOLDER_ANIM_SINGLE_FRAME(Kpoppet);
PLACEHOLDER_ANIM_SINGLE_FRAME(Gangnamp);
PLACEHOLDER_ANIM_SINGLE_FRAME(Surfice);
PLACEHOLDER_ANIM_SINGLE_FRAME(Macabrerg);
PLACEHOLDER_ANIM_SINGLE_FRAME(Eldracier);
PLACEHOLDER_ANIM_SINGLE_FRAME(Astlure);
PLACEHOLDER_ANIM_SINGLE_FRAME(Etikub);
PLACEHOLDER_ANIM_SINGLE_FRAME(Desmanther);
PLACEHOLDER_ANIM_SINGLE_FRAME(Flexnake);
PLACEHOLDER_ANIM_SINGLE_FRAME(Flexail);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hootube);
PLACEHOLDER_ANIM_SINGLE_FRAME(Channowl);
PLACEHOLDER_ANIM_SINGLE_FRAME(Squeegee);
PLACEHOLDER_ANIM_SINGLE_FRAME(Whyteepee);
PLACEHOLDER_ANIM_SINGLE_FRAME(Shipostar);
PLACEHOLDER_ANIM_SINGLE_FRAME(Skelipede);
PLACEHOLDER_ANIM_SINGLE_FRAME(Coffinsect);
PLACEHOLDER_ANIM_SINGLE_FRAME(Enabstract);
PLACEHOLDER_ANIM_SINGLE_FRAME(Cursworm);
PLACEHOLDER_ANIM_SINGLE_FRAME(Windoworm);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pupparmy);
PLACEHOLDER_ANIM_SINGLE_FRAME(Fandam);
...
// REWIND
SINGLE_ANIMATION(Paropeat);
SINGLE_ANIMATION(Macaument);
SINGLE_ANIMATION(Arguwint);
SINGLE_ANIMATION(Primatio);
SINGLE_ANIMATION(Opinimp);
SINGLE_ANIMATION(Temperilla);
SINGLE_ANIMATION(Substee);
SINGLE_ANIMATION(Manember);
SINGLE_ANIMATION(Trechiber);
SINGLE_ANIMATION(Weepillar);
SINGLE_ANIMATION(Coccoopsy);
SINGLE_ANIMATION(Apolofly);
/*SINGLE_ANIMATION(Bulbite);
SINGLE_ANIMATION(Lampupa);
SINGLE_ANIMATION(Elecreep);*/
SINGLE_ANIMATION(Acturunk);
SINGLE_ANIMATION(Dramaspire);
SINGLE_ANIMATION(Burrobit);
SINGLE_ANIMATION(Rabbitate);
SINGLE_ANIMATION(Hoodenki);
SINGLE_ANIMATION(Vanowl);
SINGLE_ANIMATION(Empeross);
/*SINGLE_ANIMATION(Cuckoob);
SINGLE_ANIMATION(Twiddies);
SINGLE_ANIMATION(Airiola);*/
SINGLE_ANIMATION(Standaad);
SINGLE_ANIMATION(Reckloat);
SINGLE_ANIMATION(Deviloat);
SINGLE_ANIMATION(Hugream);
SINGLE_ANIMATION(Traumare);
/*SINGLE_ANIMATION(Kitkar);
SINGLE_ANIMATION(Canneko);*/
SINGLE_ANIMATION(Pikash);
SINGLE_ANIMATION(Sonikachu);
SINGLE_ANIMATION(Grubfeed);
SINGLE_ANIMATION(Kwizbee);
SINGLE_ANIMATION(Cosmonarch);
SINGLE_ANIMATION(Paastel);
SINGLE_ANIMATION(Sheepastry);
SINGLE_ANIMATION(Typurr);
SINGLE_ANIMATION(Calikey);
SINGLE_ANIMATION(Spookids);
SINGLE_ANIMATION(Togeterror);
SINGLE_ANIMATION(Bubozoa);
SINGLE_ANIMATION(Chrysapod);
/*SINGLE_ANIMATION(Argigami);
SINGLE_ANIMATION(Disputraw);
SINGLE_ANIMATION(Disputrawspecial);*/
SINGLE_ANIMATION(Lemonavian);
SINGLE_ANIMATION(Muncharlie);
SINGLE_ANIMATION(Fingator);
SINGLE_ANIMATION(Garasite);
SINGLE_ANIMATION(Owlie);
SINGLE_ANIMATION(Chrythical);
SINGLE_ANIMATION(Griffeter);
SINGLE_ANIMATION(Mustelit);
SINGLE_ANIMATION(Capensear);
SINGLE_ANIMATION(Dathokyd);
SINGLE_ANIMATION(Sithabrak);
SINGLE_ANIMATION(Murmic);
SINGLE_ANIMATION(Whispectra);
SINGLE_ANIMATION(Dreamie);
SINGLE_ANIMATION(Dreamenace);
SINGLE_ANIMATION(Cubble);
SINGLE_ANIMATION(Gesundha);
SINGLE_ANIMATION(Minetle);
SINGLE_ANIMATION(Tortomotiv);
SINGLE_ANIMATION(Dinugget);
SINGLE_ANIMATION(Spinosnax);
SINGLE_ANIMATION(Ganeck);
SINGLE_ANIMATION(Alienoose);
SINGLE_ANIMATION(Mimicrate);
SINGLE_ANIMATION(MimicrateDisguised);
SINGLE_ANIMATION(Whallic);
SINGLE_ANIMATION(Enormeat);
SINGLE_ANIMATION(Vegava);
SINGLE_ANIMATION(Gluttocado);
SINGLE_ANIMATION(Postle);
SINGLE_ANIMATION(Hushback);
SINGLE_ANIMATION(Donkrime);
SINGLE_ANIMATION(Mafiadass);
SINGLE_ANIMATION(Locomalter);
SINGLE_ANIMATION(Pupyro);
SINGLE_ANIMATION(Pyrulpes);
SINGLE_ANIMATION(Kitsinical);
SINGLE_ANIMATION(Fingragon);
SINGLE_ANIMATION(Hydramily);
SINGLE_ANIMATION(Geodad);
SINGLE_ANIMATION(Snozomi);
SINGLE_ANIMATION(Everipst);
SINGLE_ANIMATION(Darkorpse);
SINGLE_ANIMATION(Hatchaal);
SINGLE_ANIMATION(Crusygle);
SINGLE_ANIMATION(Zalgosix);
SINGLE_ANIMATION(Zalgoner);
SINGLE_ANIMATION(Scorpewon);
SINGLE_ANIMATION(Tsarachnid);
SINGLE_ANIMATION(Kpoppet);
SINGLE_ANIMATION(Gangnamp);
SINGLE_ANIMATION(Surfice);
SINGLE_ANIMATION(Macabrerg);
SINGLE_ANIMATION(Eldracier);
SINGLE_ANIMATION(Astlure);
SINGLE_ANIMATION(Etikub);
SINGLE_ANIMATION(Desmanther);
SINGLE_ANIMATION(Flexnake);
SINGLE_ANIMATION(Flexail);
SINGLE_ANIMATION(Hootube);
SINGLE_ANIMATION(Channowl);
SINGLE_ANIMATION(Squeegee);
SINGLE_ANIMATION(Whyteepee);
SINGLE_ANIMATION(Shipostar);
SINGLE_ANIMATION(Skelipede);
SINGLE_ANIMATION(Coffinsect);
SINGLE_ANIMATION(Enabstract);
SINGLE_ANIMATION(Cursworm);
SINGLE_ANIMATION(Windoworm);
SINGLE_ANIMATION(Pupparmy);
SINGLE_ANIMATION(Fandam);
