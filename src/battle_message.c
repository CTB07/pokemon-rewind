...
static const u8 sText_RadiationToxic[] = _("{B_ATK_NAME_WITH_PREFIX}'s radiation spreads\nacross the battlefield!");
...
static const u8 sText_NoFucksEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} gives no fucks!");
static const u8 sText_DemonetizeEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} demonetizes the\n battlefield!");
static const u8 sText_BuffooneryActivates[] = _("{B_ATK_NAME_WITH_PREFIX} escapes\nrecharge!");
static const u8 sText_LifeDrinkerActivates[] = _("{B_ATK_NAME_WITH_PREFIX}'s  {B_ATK_ABILITY}\nallowed it to drain\l{B_DEF_NAME_WITH_PREFIX}'s energy!");
static const u8 sText_LifeDrinkerLiquidOoze[] = _("{B_ATK_NAME_WITH_PREFIX}'s  {B_ATK_ABILITY}\nsucked up liquid ooze!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_NOFUCKSENTERS - BATTLESTRINGS_TABLE_START] = sText_NoFucksEnters,
    [STRINGID_DEMONETIZEENTERS - BATTLESTRINGS_TABLE_START] = sText_DemonetizeEnters,
    [STRINGID_BUFFOONERYACTIVATES - BATTLESTRINGS_TABLE_START] = sText_BuffooneryActivates,
    [STRINGID_LIFEDRINKERACTIVATES - BATTLESTRINGS_TABLE_START] = sText_LifeDrinkerActivates,
    [STRINGID_LIFEDRINKERLIQUIDOOZE - BATTLESTRINGS_TABLE_START] = sText_LifeDrinkerLiquidOoze,
    ...
    [STRINGID_RADIATIONTOXIC  - BATTLESTRINGS_TABLE_START] = sText_RadiationToxic,
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_NO_FUCKS] = STRINGID_NOFUCKSENTERS,
    [B_MSG_SWITCHIN_DEMONETIZE] = STRINGID_DEMONETIZEENTERS,
};
