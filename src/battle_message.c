...
static const u8 sText_NoFucksEnters[] = _("{B_ATK_NAME_WITH_PREFIX} gives no fucks!");
static const u8 sText_DemonetizeEnters[] = _("{B_ATK_NAME_WITH_PREFIX} demonetizes the\n battlefield!");
