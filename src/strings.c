...
const u8 gText_HereYouGoThankYou[] = _("It's yours, my friend.");
const u8 gText_ThankYouIllSendItHome[] = _("Thank you!\nI'll send it to your home PC.");
const u8 gText_ThanksIllSendItHome[] = _("Thanks!\nI'll send it to your PC at home.");
const u8 gText_YouDontHaveMoney[] = _("Sorry, {PLAYER}. I can't give credit.\nCome back when you're a little…\pMMMM…richer!{PAUSE_UNTIL_PRESS}");
