...
// Start of Rewind Moves
extern const u8 Move_BIG_DEBATE[];
extern const u8 Move_LEGION_BASH[];
extern const u8 Move_MOB_MENTALITY[];
extern const u8 Move_MIC_DROP[];
extern const u8 Move_MORDANT_ACID[];
extern const u8 Move_VAPOR_WAVE[];
extern const u8 Move_LENS_FLARE[];
extern const u8 Move_JUSTICE_HAMMER[];
extern const u8 Move_LEAD_CANNON[];
extern const u8 Move_PSYCH_OUT[];
extern const u8 Move_PANIC_SWEAT[];
extern const u8 Move_PIXIE_PETAL[];
extern const u8 Move_MIND_PIECE[];
extern const u8 Move_DIVEBOMB[];
extern const u8 Move_REWIND[];
extern const u8 Move_MENTAL_STRIKE[];
extern const u8 Move_NARUTO_RUN[];
extern const u8 Move_LEEK_SPIN[];
extern const u8 Move_DOUBLE_CLICK[];
extern const u8 Move_BLUE_SCREEN[];
extern const u8 Move_SPIN_DASH[];
extern const u8 Move_SYNTH_WAVE[];
extern const u8 Move_ENVELOP[];
extern const u8 Move_FROSTBITE[];
extern const u8 Move_ASSASSINATE[];
extern const u8 Move_GUN[];
extern const u8 Move_VENT_KILL[];
extern const u8 Move_EJECT[];
extern const u8 Move_TOXIC_ATTITUDE[];
extern const u8 Move_HIVE_MIND[];
extern const u8 Move_TSUNAMI[];
extern const u8 Move_SANDBLASTER[];
extern const u8 Move_FREEZE_FRAME[];
extern const u8 Move_EROSION_RAY[];
extern const u8 Move_BROKEN_ARIA[];
extern const u8 Move_MOP[];
extern const u8 Move_GAMER_RAGE[];
extern const u8 Move_MOOD_CRUSH[];
